...
class TrainConfig:
    ...
    render: bool = True  # Whether to render the environment and save outputs in eval_gifs
    ...
    # Wandb logging
    project: str = "CQL"
    group: str = "drawer-open"
    name: str = "CQL"
    name = name + str(seed)

    if vlm_reward:
        name = name + "-vlm_reward"
    elif const_reward is not None:
        name = name + "-const_reward-" + str(const_reward)
    elif average_reward:
        name = name + "-average_reward"
