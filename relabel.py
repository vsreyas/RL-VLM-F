...
def main(cfg):
    ...
    with open("/home/venky/Desktop/RL-VLM-F/test_dummy/cartpole/data_replay_corrected.pkl", 'rb') as f:
        data = pkl.load(f)
    workspace.relabel(data)
    print(len(data["rewards_pred"]))
    demo_dir = "/home/venky/Desktop/RL-VLM-F/test_dummy/cartpole/"
    with open(f"{demo_dir}/data_replay_corrected_pred.pkl", "wb") as f:
        pkl.dump(data, f)
